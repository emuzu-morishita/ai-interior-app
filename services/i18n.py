...
TRANSLATIONS = {
    "ja": {
        ...
        "selected_badge": "選択中",
        "price_select_label": "価格に反映する商品を選ぶ",
        "price_use_ai": "AIの概算（¥{price:,}）",
        "price_use_product": "{source}：{name} ¥{price:,}",
        "selected_product_label": "選択商品",
        "budget_label": "予算 (円)",
        "budget_metric": "設定予算",
    ...
    "en": {
        ...
        "price_select_label": "Choose the product to apply to the price",
        "price_use_ai": "AI estimate (¥{price:,})",
        "price_use_product": "{source}: {name} ¥{price:,}",
    ...
    "ko": {
        ...
        "selected_badge": "선택됨",
        "price_select_label": "가격에 반영할 상품 선택",
        "price_use_ai": "AI 개산 (¥{price:,})",
        "price_use_product": "{source}: {name} ¥{price:,}",
        "selected_product_label": "선택 상품",
        "budget_label": "예산 (엔)",
        "budget_metric": "설정 예산",
    ...
    "zh": {
        ...
        "selected_badge": "已选",
        "price_select_label": "选择用于价格的商品",
        "price_use_ai": "AI 估算（¥{price:,}）",
        "price_use_product": "{source}：{name} ¥{price:,}",
        "selected_product_label": "已选商品",
        "budget_label": "预算 (日元)",
        "budget_metric": "设定预算",
        "generate_btn": "生成搭配方案",
    ...
    "pt": {
        ...
        "price_select_label": "Escolha o produto para aplicar ao preço",
        "price_use_ai": "Estimativa da IA (¥{price:,})",
        "price_use_product": "{source}: {name} ¥{price:,}",
        "selected_product_label": "Produto selecionado",
